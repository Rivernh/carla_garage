...
export CARLA_ROOT=/opt/data/private/jurunkun-flash/hmy/carla
export WORK_DIR=/opt/data/private/jurunkun-flash/ylh/b2d_workspace/carla_garage_2/carla_garage/Bench2Drive
export SCENARIO_RUNNER_ROOT=${WORK_DIR}/scenario_runner
export LEADERBOARD_ROOT=${WORK_DIR}/leaderboard
export PYTHONPATH=$PYTHONPATH:/opt/data/private/jurunkun-flash/ylh/b2d_workspace/carla_garage_2/carla_garage/team_code
...
BASE_TM_PORT=2500
IS_BENCH2DRIVE=True
BASE_ROUTES=${WORK_DIR}/leaderboard/data/bench2drive20_select.xml
TEAM_AGENT=/opt/data/private/jurunkun-flash/ylh/b2d_workspace/carla_garage_2/carla_garage/team_code/sensor_agent.py
# Must set YOUR_CKPT_PATH
TEAM_CONFIG=/opt/data/private/jurunkun-flash/ylh/b2d_workspace/carla_garage_2/pretrained_models/all_towns
BASE_CHECKPOINT_ENDPOINT=eval_bench2drive20
PLANNER_TYPE=traj
ALGO=tfpp
...
if [ ! -f "${BASE_ROUTES}_${ALGO}_${PLANNER_TYPE}_split_done.flag" ]; then
    ...
    TASK_NUM=1 # 8*H100, 1 task per gpu
